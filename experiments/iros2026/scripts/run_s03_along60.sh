#!/bin/bash
# S03: raceline a_long 6.0 (S02 ran 5.5). Controller identical to A03/S01/S02.
...
ros2 launch racer_bringup race.launch.py \
  ...
  path_csv:=/root/Documents/roboracer/raceline/iros2026/raceline_tum_iqp_h7.0_L60_a7.0b.csv \
  log_csv:=/root/Documents/roboracer/logs/accel_s03.csv \
