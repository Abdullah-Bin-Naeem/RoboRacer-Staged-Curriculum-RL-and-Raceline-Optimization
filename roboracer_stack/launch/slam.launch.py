"""Localizer B: slam_toolbox in localization mode, against a serialized pose graph.
    ...
    ros2 launch roboracer_stack slam.launch.py
...
roboracer_stack.common.frames.SPAWN_* and nothing else. Run once with
...
from roboracer_stack.common.frames import (
    BASE, DEFAULT_POSE_GRAPH, MAP, NS, ODOM, SPAWN_X, SPAWN_Y, SPAWN_YAW)
...
def _nodes(context, *args, **kwargs):
    ...
    return [
        ...
        # roboracer_stack slam.launch.py` -- the obvious command for debugging
